    ...
    public class ConnectionController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                ...
                ViewBag.StationsCount = await _context.Stations.CountAsync();
                ViewBag.UnitsCount = await _context.Units.CountAsync();
                ViewBag.EmergenciesCount = await _context.Emergencies.CountAsync();
                ViewBag.NotificationsCount = await _context.Notifications.CountAsync();
                ...
                if (canConnect)
                {
                    result = new
                    {
                        ...
                        details = new Dictionary<string, object>
                        {
                            ...
                            { "emergencies", await _context.Emergencies.CountAsync() },
